...
// bitsilver includes.
#include <..\src\script\bitsilverconsensus.h>
...
int main()
{
    std::cout << "bitsilverconsensus version: " << bitsilverconsensus_version() << std::endl;
    ...
    auto op0Result = bitsilverconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bitsilverconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
