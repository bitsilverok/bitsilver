# Bootstrappable BitSilver Core Builds

This directory contains the files necessary to perform bootstrappable BitSilver
Core builds.
...
- 24GB of free disk space on the partition that the BitSilver Core git repository
  resides in
...
For a BitSilver Core depends development environment, simply invoke
...
From the top of a clean BitSilver Core repository:
...
To use dongcarl's substitute server for BitSilver Core builds after having
