...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitsilver repository."
  exit 1
fi
...
# See https://github.com/bitsilver/bitsilver/issues/16064
...
echo 'When compiling bitsilverd, run `./configure` in the following way:'
echo
