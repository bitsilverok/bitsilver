Contributing to BitSilver Core
============================

The BitSilver Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/bitsilver/bitsilver/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [BitSilver Core PR Review Club](https://bitsilvercore.reviews/) meeting.

Communication Channels
----------------------

Most communication about BitSilver Core development happens on IRC, in the
#bitsilver-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/bitsilver-core-dev/](http://www.erisian.com.au/bitsilver-core-dev/)
and [http://gnusha.org/bitsilver-core-dev/](http://gnusha.org/bitsilver-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/bitsilver-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bitsilver-qt
...
[Translation Process](https://github.com/bitsilver/bitsilver/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BitSilver Core project (and related
projects such as libsecp256k1), and is not to be confused with overall BitSilver
Network Protocol consensus changes.

Whether a pull request is merged into BitSilver Core rests with the project merge
...
Patches that change BitSilver consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitSilver consensus, it must have been
...
https://github.com/bitsilver/bitsilver/pull/16189).

Also see the [backport.py script](
https://github.com/bitsilver-core/bitsilver-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each BitSilver Core release.
