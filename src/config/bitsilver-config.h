/* src/config/bitsilver-config.h.  Generated from bitsilver-config.h.in by configure.  */
/* src/config/bitsilver-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BITSILVER_CONFIG_H

#define BITSILVER_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BitSilver Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BitSilver Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bitsilver/bitsilver/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitSilver Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitSilver Core 0.19.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitsilver"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitsilvercore.org/"
