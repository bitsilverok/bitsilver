...
#ifndef BITSILVER_WALLET_SCRIPTPUBKEYMAN_H
#define BITSILVER_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BitSilver Core wallet was originally a collection of unrelated private
...
#endif // BITSILVER_WALLET_SCRIPTPUBKEYMAN_H
