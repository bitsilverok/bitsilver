...
#ifndef BITSILVER_WALLET_WALLET_H
#define BITSILVER_WALLET_WALLET_H
...
public:
     ...
     * on this bitsilver node, and set to 0 for transactions that were created
...
#endif // BITSILVER_WALLET_WALLET_H
