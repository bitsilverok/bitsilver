...
#ifndef BITSILVER_TEST_SCRIPTNUM10_H
#define BITSILVER_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitSilver Core 0.10.0, for cross-comparison.
 */
public:
