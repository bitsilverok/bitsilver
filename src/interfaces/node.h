...
#ifndef BITSILVER_INTERFACES_NODE_H
#define BITSILVER_INTERFACES_NODE_H
...
//! Top-level interface for a bitsilver node (bitsilverd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITSILVER_INTERFACES_NODE_H
