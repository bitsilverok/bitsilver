...
#ifndef BITSILVER_INTERFACES_CHAIN_H
#define BITSILVER_INTERFACES_CHAIN_H
...
//! internal workings of the bitsilver node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/bitsilver/bitsilver/pull/10973#issuecomment-380101269).
//!
//! * The initMessage() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/bitsilver/bitsilver/pull/15288#discussion_r253321096).
//!
...
#endif // BITSILVER_INTERFACES_CHAIN_H
