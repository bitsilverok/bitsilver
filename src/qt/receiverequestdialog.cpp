...
#include <config/bitsilver-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBitSilverURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + BitSilverUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBitSilverURI(info));
}
