...
#ifndef BITSILVER_QT_SPLASHSCREEN_H
#define BITSILVER_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. BitSilver Core initialization
...
#endif // BITSILVER_QT_SPLASHSCREEN_H
