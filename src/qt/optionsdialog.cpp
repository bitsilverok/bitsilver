    ...
    mapper(nullptr)
{
    ...
    ui->bitsilverAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitsilverAtStartup);
    ...
    ui->bitsilverAtStartup->setToolTip(ui->bitsilverAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitsilverAtStartup->setText(ui->bitsilverAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitSilverConfButton->setToolTip(ui->openBitSilverConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitSilverUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitsilverAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitSilverConfButton_clicked()
{
