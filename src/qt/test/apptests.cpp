...
//! Entry point for BitSilverApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitSilverApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitSilverGUI tests.
void AppTests::guiTests(BitSilverGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitSilverGUI::consoleShown, this, &AppTests::consoleTests);
