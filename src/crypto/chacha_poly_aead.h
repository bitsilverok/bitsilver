...
#ifndef BITSILVER_CRYPTO_CHACHA_POLY_AEAD_H
#define BITSILVER_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitsilver.
 *
 ...
 *
 * The chacha20-poly1305@bitsilver combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitsilver cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitsilver are relatively fast in
...
#endif // BITSILVER_CRYPTO_CHACHA_POLY_AEAD_H
