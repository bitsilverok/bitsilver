// Copyright (c) 2019-2020 The BitSilver Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITSILVER_UTIL_SETTINGS_H
#define BITSILVER_UTIL_SETTINGS_H
...
//!       https://github.com/bitsilver/bitsilver/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored bitsilver settings. This struct combines settings from the command line
...
#endif // BITSILVER_UTIL_SETTINGS_H
