...
#ifndef BITSILVER_UTIL_MESSAGE_H
#define BITSILVER_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitsilver address, it must refer to a public key.
...
#endif // BITSILVER_UTIL_MESSAGE_H
