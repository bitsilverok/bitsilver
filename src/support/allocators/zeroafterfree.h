...
#ifndef BITSILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITSILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITSILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
