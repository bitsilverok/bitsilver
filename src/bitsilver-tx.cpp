...
static void SetupBitSilverTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitsilver-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitsilver-tx [options] <hex-tx> [commands]  Update hex-encoded bitsilver transaction\n" +
            "or:     bitsilver-tx [options] -create [commands]   Create hex-encoded bitsilver transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitsilver transaction
