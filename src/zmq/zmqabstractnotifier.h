// Copyright (c) 2015-2018 The BitSilver Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITSILVER_ZMQ_ZMQABSTRACTNOTIFIER_H
#define BITSILVER_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // BITSILVER_ZMQ_ZMQABSTRACTNOTIFIER_H
