BitSilver version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/BitSilver/bitcoin-0.5.4/
...
Fix BitSilver-Qt notifications under Growl 1.3.
Increase required age of BitSilver-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitSilver properly when installing BitSilver-Qt over it. (Windows)
