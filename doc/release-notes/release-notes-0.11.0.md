BitSilver Core version 0.11.0 is now available from:
...
Block pruning allows BitSilver Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that BitSilver Core will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only BitSilverAmountField
...
- #6116 `30dc3c1` [OSX] rename BitSilver-Qt.app to BitSilver-Core.app
