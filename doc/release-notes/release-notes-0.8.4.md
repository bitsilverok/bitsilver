BitSilver-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/BitSilver/bitcoin-0.8.4/
...
code, causing the BitSilver-Qt or bitcoind process to crash.
...
their own version of BitSilver against Boost versions 1.50-1.52.
