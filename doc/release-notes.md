*After branching off for a major version release of BitSilver Core, use this
...
https://github.com/bitsilver-core/bitsilver-devwiki/wiki/
...
BitSilver Core version *version* is now available from:

  <https://bitsilvercore.org/bin/bitsilver-core-*version*/>
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/bitsilver/bitsilver/issues>

To receive security and update notifications, please subscribe to:

  <https://bitsilvercore.org/en/list/announcements/join/>
...
or `bitsilverd`/`bitsilver-qt` (on Linux).
...
From BitSilver Core 0.20.0 onwards, macOS versions earlier than 10.12 are no
longer supported. Additionally, BitSilver Core does not yet change appearance
...
#### Removal of reject network messages from BitSilver Core (BIP61)

The command line option to enable BIP61 (`-enablebip61`) has been removed.

This feature has been disabled by default since BitSilver Core version 0.18.0.
Nodes on the network can not generally be trusted to send valid ("reject")
messages, so this should only ever be used when connected to a trusted node.
Please use the recommended alternatives if you rely on this deprecated feature:

* Testing or debugging of implementations of the BitSilver P2P network protocol
  should be done by inspecting the log messages that are produced by a recent
  version of BitSilver Core. BitSilver Core logs debug messages
...
- `testmempoolaccept` and `sendrawtransaction` no longer return the P2P REJECT
  ...
  _Removal of reject network messages from BitSilver Core (BIP61)_ for details on
...
- OpenSSL is no longer used by BitSilver Core. The last usage of the library
...
- A new `-asmap` configuration option has been added to enable IP-to-ASN mapping
  ...
  #16599](https://github.com/bitsilver/bitsilver/issues/16599), [PR
  #16702](https://github.com/bitsilver/bitsilver/pull/16702), and the `bitsilverd
...
- The "Start BitSilver Core on system login" option has been removed on macOS.
...
[Transifex](https://www.transifex.com/bitsilver/bitsilver/).
