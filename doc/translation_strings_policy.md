...
This document provides guidelines for internationalization of the BitSilver Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitsilver_en.ts` remains unchanged.
