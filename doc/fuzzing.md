...
```
git clone https://github.com/bitsilver-core/qa-assets
...
To build BitSilver Core using AFL instrumentation (this assumes that the
...
with certain assembly code from BitSilver Core's code. See [developer notes on sanitizers](https://github.com/bitsilver/bitsilver/blob/master/doc/developer-notes.md#sanitizers)
