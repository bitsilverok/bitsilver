...
By default, BitSilver Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that bitsilver's trustless model works best if you are
