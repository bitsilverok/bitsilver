...
class TestShell:
    """Wrapper Class for BitSilverTestFramework.

    The TestShell class extends the BitSilverTestFramework
    ...
    class __TestShell(BitSilverTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitSilverTestFramework child class.
            self.num_nodes = 1
