...
"""Verify that starting bitsilver with -h works as expected."""

from test_framework.test_framework import BitSilverTestFramework
from test_framework.util import assert_equal

class HelpTest(BitSilverTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitsilver with -h for help text")
        ...
        self.log.info("Start bitsilver with -version for version information")
        ...
        self.log.info("Start bitsilverd with -fakearg to make sure it does not start")
