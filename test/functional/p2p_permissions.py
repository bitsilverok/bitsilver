...
class P2PPermissionsTests(BitSilverTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitsilverconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bitsilverconf, 'w', encoding="utf8") as f:
            f.write(newText)
