...
By default, bitsilverd will dump mempool on shutdown and
...
class MempoolPersistTest(BitSilverTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitsilverd from writing mempool.dat to disk. Verify that `savemempool` fails")
